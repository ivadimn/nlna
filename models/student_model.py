...
INSERT = """
    INSERT INTO student (f_fio, f_phone, f_email, f_comment) 
    VALUES(?, ?, ?, ?);
"""

UPDATE = """
    UPDATE student SET f_fio=?, f_phone=?, f_email=?, f_comment=? 
    WHERE id=? ;
"""
...
class StudentModel(QSqlQueryModel):
    ...
    def refresh(self):
        sql = "SELECT id, f_fio, f_phone, f_email, f_comment FROM student;"
        self.setQuery(sql)
